...
unsafe fn yv12_extend_frame_top_c(mut ybf: *mut YV12_BUFFER_CONFIG) {
    unsafe {
        ...
        while i < Border as i32 {
            core::ptr::copy_nonoverlapping(src_ptr1 as *const c_void as *const u8, dest_ptr1 as *mut c_void as *mut u8, plane_stride as size_t);
...
unsafe fn yv12_extend_frame_bottom_c(mut ybf: *mut YV12_BUFFER_CONFIG) {
    unsafe {
        ...
        i = 0 as i32;
        while i < Border as i32 {
            core::ptr::copy_nonoverlapping(src_ptr2 as *const c_void as *const u8, dest_ptr2 as *mut c_void as *mut u8, plane_stride as size_t);
...
unsafe fn yv12_extend_frame_left_right_c(
    ...
    unsafe {
        ...
        while i < plane_height {
            core::ptr::write_bytes(dest_ptr1 as *mut c_void as *mut u8, *src_ptr1.offset(0 as isize) as i32 as u8, Border as size_t);
            core::ptr::write_bytes(dest_ptr2 as *mut c_void as *mut u8, *src_ptr2.offset(0 as isize) as i32 as u8, Border as size_t);
...
unsafe fn init_frame(mut pbi: *mut VP8D_COMP) {
    unsafe {
        ...
        if (*pc).frame_type as u32 == KEY_FRAME as u32 {
            core::ptr::copy_nonoverlapping(&raw const vp8_default_mv_context as *const MV_CONTEXT as *const c_void as *const u8, &raw mut (*pc).fc.mvc as *mut MV_CONTEXT as *mut c_void as *mut u8, ::core::mem::size_of::<[MV_CONTEXT; 2]>() as size_t);
            vp8_init_mbmode_probs(pc);
            vp8_default_coef_probs(pc as *mut VP8Common);
            core::ptr::write_bytes(&raw mut (*xd).segment_feature_data as *mut [i8; 4] as *mut c_void as *mut u8, 0 as i32 as u8, ::core::mem::size_of::<[[i8; 4]; 2]>() as size_t);
            (*xd).mb_segment_abs_delta = SEGMENT_DELTADATA as u8;
            core::ptr::write_bytes(&raw mut (*xd).ref_lf_deltas as *mut i8 as *mut c_void as *mut u8, 0 as i32 as u8, ::core::mem::size_of::<[i8; 4]>() as size_t);
            core::ptr::write_bytes(&raw mut (*xd).mode_lf_deltas as *mut i8 as *mut c_void as *mut u8, 0 as i32 as u8, ::core::mem::size_of::<[i8; 4]>() as size_t);
    ...
    unsafe {
        ...
        if (*xd).segmentation_enabled != 0 {
            ...
            if (*xd).update_mb_segmentation_map != 0 {
                core::ptr::write_bytes(&raw mut (*xd).mb_segment_tree_probs as *mut vp8_prob as *mut c_void as *mut u8, 255 as i32 as u8, ::core::mem::size_of::<[vp8_prob; 3]>() as size_t);
                i = 0 as i32;
        ...
        core::ptr::write_bytes(&raw mut (*xd).qcoeff as *mut i16 as *mut c_void as *mut u8, 0 as i32 as u8, ::core::mem::size_of::<[i16; 400]>() as size_t);
        vp8_decode_mode_mvs(pbi);
        core::ptr::write_bytes((*pc).above_context as *mut c_void as *mut u8, 0 as i32 as u8, (::core::mem::size_of::<ENTROPY_CONTEXT_PLANES>() as size_t)
