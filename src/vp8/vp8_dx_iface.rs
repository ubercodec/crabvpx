...
pub type Vp8ComControlId = u32;
pub const VP8_DECODER_CTRL_ID_START: Vp8ComControlId = 256;
pub const VP8_COMMON_CTRL_ID_MAX: Vp8ComControlId = 129;
pub const VP9_GET_REFERENCE: Vp8ComControlId = 128;
pub const VP8_SET_POSTPROC: Vp8ComControlId = 3;
pub const VP8_COPY_REFERENCE: Vp8ComControlId = 2;
pub const VP8_SET_REFERENCE: Vp8ComControlId = 1;
pub type Vp8PostprocLevel = u32;
pub const VP8_MFQE: Vp8PostprocLevel = 8;
pub const VP8_ADDNOISE: Vp8PostprocLevel = 4;
pub const VP8_DEMACROBLOCK: Vp8PostprocLevel = 2;
pub const VP8_DEBLOCK: Vp8PostprocLevel = 1;
pub const VP8_NOFILTERING: Vp8PostprocLevel = 0;
...
pub type VpxRefFrameTypeT = VpxRefFrameType;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct VpxRefFrame {
    pub frame_type: VpxRefFrameTypeT,
    pub img: VpxImageT,
}
...
pub const VPXD_SET_DECRYPTOR: Vp8DecControlId = 259;
pub const VPXD_GET_LAST_QUANTIZER: Vp8DecControlId = 267;
pub const LAST_FRAME: C2RustUnnamed_5 = 1;
pub const GOLDEN_FRAME: C2RustUnnamed_5 = 2;
pub const ALTREF_FRAME: C2RustUnnamed_5 = 3;
pub const VP8D_GET_LAST_REF_USED: Vp8DecControlId = 258;
pub const VP8D_GET_FRAME_CORRUPTED: Vp8DecControlId = 257;
pub const VP8D_GET_LAST_REF_UPDATES: Vp8DecControlId = 256;
pub type Vp8DecControlId = u32;
pub const VP8_DECODER_CTRL_ID_MAX: Vp8DecControlId = 270;
pub const VP9D_SET_LOOP_FILTER_OPT: Vp8DecControlId = 269;
pub const VP9D_SET_ROW_MT: Vp8DecControlId = 268;
pub const VP9_DECODE_SVC_SPATIAL_LAYER: Vp8DecControlId = 266;
pub const VP9_SET_SKIP_LOOP_FILTER: Vp8DecControlId = 265;
pub const VP9_INVERT_TILE_DECODE_ORDER: Vp8DecControlId = 264;
pub const VP9_SET_BYTE_ALIGNMENT: Vp8DecControlId = 263;
pub const VP9D_GET_BIT_DEPTH: Vp8DecControlId = 262;
pub const VP9D_GET_DISPLAY_SIZE: Vp8DecControlId = 261;
pub const VP9D_GET_FRAME_SIZE: Vp8DecControlId = 260;
pub const VP8D_SET_DECRYPTOR: Vp8DecControlId = 259;
...
unsafe fn vp8_init_ctx(mut ctx: *mut VpxCodecCtxT) -> i32 {
    unsafe {
        let mut priv_0: *mut VpxCodecAlgPrivT = vpx_calloc(
            1 as SizeT,
            ::core::mem::size_of::<VpxCodecAlgPrivT>() as SizeT,
...
unsafe fn vp8_init(mut ctx: *mut VpxCodecCtxT, _data: *mut VpxCodecPrivEncMrCfgT) -> VpxCodecErrT {
    unsafe {
...
unsafe fn vp8_destroy(mut ctx: *mut VpxCodecAlgPrivT) -> VpxCodecErrT {
    unsafe {
    ...
    unsafe {
        ...
        if (*ctx).fragments.count == 0 as u32 {
            core::ptr::write_bytes(
                ...
                0 as i32 as u8,
                ::core::mem::size_of::<[*const u8; 9]>() as SizeT,
            );
            core::ptr::write_bytes(
...
unsafe fn vp8_decode(
    ...
    unsafe {
            ...
            && (*ctx).si.w == 0 as u32
        {
            ...
            ::core::ptr::write_volatile(&mut res as *mut VpxCodecErrT, VPX_CODEC_CORRUPT_FRAME);
            vpx_internal_error(
    ...
    unsafe {
        ...
        if (*iter).is_null() && !(*ctx).yv12_frame_buffers.pbi[0 as usize].is_null() {
            ...
            core::ptr::write_bytes(
                ...
                0 as i32 as u8,
                ::core::mem::size_of::<Vp8PpflagsT>() as SizeT,
            );
            if (*ctx).base.init_flags & VPX_CODEC_USE_POSTPROC as VpxCodecFlagsT != 0 {
...
unsafe fn vp8_set_reference(mut ctx: *mut VpxCodecAlgPrivT, mut data: *mut c_void) -> VpxCodecErrT {
    unsafe {
        ...
        if !data.is_null() {
            ...
            vp8dx_set_reference(
                (*ctx).yv12_frame_buffers.pbi[0 as usize],
                (*frame).frame_type as VpxRefFrameType,
                &raw mut sd,
            )
        } else {
...
unsafe fn vp8_get_reference(mut ctx: *mut VpxCodecAlgPrivT, mut data: *mut c_void) -> VpxCodecErrT {
    unsafe {
        let mut data: *mut VpxRefFrameT = data as *mut VpxRefFrameT;
        if !data.is_null() {
            let mut frame: *mut VpxRefFrameT = data;
...
unsafe fn vp8_get_quantizer(mut ctx: *mut VpxCodecAlgPrivT, mut data: *mut c_void) -> VpxCodecErrT {
    unsafe {
...
unsafe fn vp8_set_decryptor(mut ctx: *mut VpxCodecAlgPrivT, mut data: *mut c_void) -> VpxCodecErrT {
    unsafe {
...
static mut vp8_ctf_maps: [VpxCodecCtrlFnMapT; 9] = {
    [
        VpxCodecCtrlFnMap {
            ...
            fn_0: Some(
                vp8_set_reference as unsafe fn(*mut VpxCodecAlgPrivT, *mut c_void) -> VpxCodecErrT,
            ),
        },
        VpxCodecCtrlFnMap {
            ctrl_id: VP8_COPY_REFERENCE as i32,
            fn_0: Some(
                vp8_get_reference as unsafe fn(*mut VpxCodecAlgPrivT, *mut c_void) -> VpxCodecErrT,
            ),
        },
        VpxCodecCtrlFnMap {
            ctrl_id: VP8_SET_POSTPROC as i32,
            fn_0: Some(
                vp8_set_postproc as unsafe fn(*mut VpxCodecAlgPrivT, *mut c_void) -> VpxCodecErrT,
            ),
        },
        VpxCodecCtrlFnMap {
            ...
            fn_0: Some(
                vp8_get_last_ref_updates
                    as unsafe fn(*mut VpxCodecAlgPrivT, *mut c_void) -> VpxCodecErrT,
            ),
        },
        VpxCodecCtrlFnMap {
        ...
        VpxCodecCtrlFnMap {
            ...
            fn_0: Some(
                vp8_get_quantizer as unsafe fn(*mut VpxCodecAlgPrivT, *mut c_void) -> VpxCodecErrT,
            ),
        },
        VpxCodecCtrlFnMap {
            ctrl_id: VPXD_SET_DECRYPTOR as i32,
            fn_0: Some(
                vp8_set_decryptor as unsafe fn(*mut VpxCodecAlgPrivT, *mut c_void) -> VpxCodecErrT,
            ),
        },
        VpxCodecCtrlFnMap {
            ctrl_id: -(1 as i32),
    ...
    unsafe {
        vpx_codec_vp8_dx_algo = VpxCodecIface {
            ...
            caps: (VPX_CODEC_CAP_DECODER
                ...
                | VPX_CODEC_CAP_INPUT_FRAGMENTS) as VpxCodecCapsT,
            init: Some(
                vp8_init
                    as unsafe fn(*mut VpxCodecCtxT, *mut VpxCodecPrivEncMrCfgT) -> VpxCodecErrT,
            ),
            destroy: Some(vp8_destroy as unsafe fn(*mut VpxCodecAlgPrivT) -> VpxCodecErrT),
            ctrl_maps: &raw const vp8_ctf_maps as *const VpxCodecCtrlFnMapT,
            dec: VpxCodecDecIface {
                peek_si: Some(
                    vp8_peek_si
                        as unsafe fn(*const u8, u32, *mut VpxCodecStreamInfoT) -> VpxCodecErrT,
                ),
                get_si: Some(
                    vp8_get_si
                        as unsafe fn(
