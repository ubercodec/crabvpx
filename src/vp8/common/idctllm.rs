    ...
    unsafe {
        ...
        while i < 4 as i32 {
            ...
            d1 = *ip.offset(0 as i32 as isize) as i32
                - *ip.offset(12 as i32 as isize) as i32;
            *op.offset(0 as i32 as isize) = (a1 + b1) as i16;
            *op.offset(4 as i32 as isize) = (c1 + d1) as i16;
            *op.offset(8 as i32 as isize) = (a1 - b1) as i16;
            *op.offset(12 as i32 as isize) = (d1 - c1) as i16;
            ip = ip.offset(1);
            op = op.offset(1);
            i += 1;
        }
