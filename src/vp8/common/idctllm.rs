...
pub unsafe fn vp8_short_idct4x4llm_c(
    ...
    unsafe {
        ...
        i = 0 as i32;
        while i < 4 as i32 {
            a1 = *ip.offset(0 as isize) as i32
                + *ip.offset(8 as isize) as i32;
            b1 = *ip.offset(0 as isize) as i32
                - *ip.offset(8 as isize) as i32;
            temp1 = (*ip.offset(4 as isize) as i32
                * sinpi8sqrt2)
                >> 16 as i32;
            temp2 = *ip.offset(12 as isize) as i32
                + ((*ip.offset(12 as isize) as i32
                    * cospi8sqrt2minus1)
                    >> 16 as i32);
            c1 = temp1 - temp2;
            temp1 = *ip.offset(4 as isize) as i32
                + ((*ip.offset(4 as isize) as i32
                    * cospi8sqrt2minus1)
                    >> 16 as i32);
            temp2 = (*ip.offset(12 as isize) as i32
                * sinpi8sqrt2)
        ...
        while i < 4 as i32 {
            ...
            temp2 = *ip.offset(3 as isize) as i32
                + ((*ip.offset(3 as isize) as i32
                    * cospi8sqrt2minus1)
                    >> 16 as i32);
            c1 = temp1 - temp2;
            temp1 = *ip.offset(1 as isize) as i32
                + ((*ip.offset(1 as isize) as i32
                    * cospi8sqrt2minus1)
                    >> 16 as i32);
            temp2 = (*ip.offset(3 as isize) as i32
                * sinpi8sqrt2)
                >> 16 as i32;
            d1 = temp1 + temp2;
            *op.offset(0 as isize) = ((a1 + d1 + 4 as i32)
                >> 3 as i32)
                as i16;
            *op.offset(3 as isize) = ((a1 - d1 + 4 as i32)
                >> 3 as i32)
                as i16;
            *op.offset(1 as isize) = ((b1 + c1 + 4 as i32)
                >> 3 as i32)
                as i16;
            *op.offset(2 as isize) = ((b1 - c1 + 4 as i32)
                >> 3 as i32)
                as i16;
...
pub unsafe fn vp8_short_inv_walsh4x4_c(
    ...
    unsafe {
        ...
        while i < 4 as i32 {
            a1 = *ip.offset(0 as isize) as i32
                + *ip.offset(12 as isize) as i32;
            b1 = *ip.offset(4 as isize) as i32
                + *ip.offset(8 as isize) as i32;
            c1 = *ip.offset(4 as isize) as i32
                - *ip.offset(8 as isize) as i32;
            d1 = *ip.offset(0 as isize) as i32
                - *ip.offset(12 as isize) as i32;
        ...
        while i < 4 as i32 {
            a1 = *ip.offset(0 as isize) as i32
                + *ip.offset(3 as isize) as i32;
            b1 = *ip.offset(1 as isize) as i32
                + *ip.offset(2 as isize) as i32;
            c1 = *ip.offset(1 as isize) as i32
                - *ip.offset(2 as isize) as i32;
            d1 = *ip.offset(0 as isize) as i32
                - *ip.offset(3 as isize) as i32;
            a2 = a1 + b1;
            ...
            c2 = a1 - b1;
            d2 = d1 - c1;
            *op.offset(0 as isize) =
                ((a2 + 3 as i32) >> 3 as i32) as i16;
            *op.offset(1 as isize) =
                ((b2 + 3 as i32) >> 3 as i32) as i16;
            *op.offset(2 as isize) =
                ((c2 + 3 as i32) >> 3 as i32) as i16;
            *op.offset(3 as isize) =
                ((d2 + 3 as i32) >> 3 as i32) as i16;
            ip = ip.offset(4 as isize);
...
pub unsafe fn vp8_short_inv_walsh4x4_1_c(
    ...
    unsafe {
        let mut i: i32 = 0;
        let mut a1: i32 = 0;
        a1 = (*input.offset(0 as isize) as i32
            + 3 as i32)
            >> 3 as i32;
        i = 0 as i32;
        while i < 16 as i32 {
